...
"""Conductor API for interfacing with Other modules"""
from oslo_config import cfg

from plasma.common import rpc_service
from plasma.conductor import config
...
class API(rpc_service.API):
    def __init__(self, transport=None, context=None, topic=None):
        if topic is None:	
            cfg.CONF.import_opt('topic', 'plasma.conductor.config',
                                group='conductor')
    ...
    def compose_nodes(self, criteria):
        return self._call('compose_nodes')
